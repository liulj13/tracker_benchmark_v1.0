...
trackers = [{struct('name','MDNet','namePaper','MDNet')},...
    {struct('name','MDNet_0','namePaper','MDNet_0')},...
    {struct('name','pyMDNet_otb2otb','namePaper','pyMDNet_otb2otb')},...  
    {struct('name','pyMDNet_13','namePaper','pyMDNet_13')},... 
    {struct('name','MDNet-N_0','namePaper','MDNet-N_0')},...      
    {struct('name','MDNet-N_5','namePaper','MDNet-N_5')}];
